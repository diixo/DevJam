...
#include "lib/dlib/src/image_processing/remove_unobtainable_rectangles_abstract.h"
...
#include "lib/dlib/src/svm/structural_object_detection_trainer.h"
#include "lib/dlib/src/geometry.h"
