...
#include "lib/dlib/src/lsh/projection_hash_abstract.h"
#include "lib/dlib/src/image_keypoint/hashed_feature_image_abstract.h"
#include "lib/dlib/src/image_keypoint/binned_vector_feature_image_abstract.h"
