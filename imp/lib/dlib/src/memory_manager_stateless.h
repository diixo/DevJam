...
#include "lib/dlib/src/memory_manager_stateless/memory_manager_stateless_kernel_1.h"
#include "lib/dlib/src/memory_manager_stateless/memory_manager_stateless_kernel_2.h"
