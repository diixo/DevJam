...
#include "lib/dlib/src/threads/threads_kernel_abstract.h"
#include "lib/dlib/src/threads/rmutex_extension_abstract.h"
#include "lib/dlib/src/threads/read_write_mutex_extension_abstract.h"
